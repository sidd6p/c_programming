...
int i = 0, j = 0, n = 0, t, total_waiting_time = 0, total_turn_arround_time = 0, pre_brust = 0;
...
printf("Burst time\t Arrival time\t WaitingTime\t Turn Arround Time\n");
for(i=0;i<n;i++){
    printf("\n%d\t\t%d\t\t%d\t\t%d",process[i].brust_time, process[i].arrival_time, process[i].waiting_time,process[i].turn_arround_time);
}
